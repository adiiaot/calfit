  ...
  return (
    ...
    <AndroidSafeView backgroundColor={theme.bg} style={styles.safe}>
          ...
          <>
            <View style={[styles.challengeBanner, {
              ...
              <Text style={[styles.challengeBannerText, { color: theme.accent }]}>
                Challenges are auto-generated by CalFit and updated regularly. Complete them to earn points and badges.
              </Text>
            </View>
            {challenges.map((c) => (
              <ChallengeCard
      ...
      <GroupDetailSheet
        ...
        onDeleteGroup={() => {
          if (selectedGroup) remove(selectedGroup.id);
        }}
      />
    </AndroidSafeView>
  );
